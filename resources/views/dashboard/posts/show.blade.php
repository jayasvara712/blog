    ...
    <div class="container">
        <div class="row my-3">
            <div class="col-lg-8">
                ...
                <a href="/dashboard/posts" class="btn btn-success"><span data-feather="arrow-left"></span> Back to my all my
                    post</a>
                ...
                @else
                    <div style="max-height: 30rem; overflow:hidden;">
                        <img src="https://source.unsplash.com/500x400?{{ $post->category->name }}" class="card-img-top mt-3"
                            alt="{{ $post->category->name }}" class="image-fluid">
                    </div>
                @endif
